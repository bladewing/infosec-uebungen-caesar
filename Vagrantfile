...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "bob" do |bob|
    ...
    bob.vm.hostname = "bob"
    bob.vm.network "private_network", ip: "192.168.56.102", virtualbox__intnet: "internal"
  ...
  config.vm.define "eve" do |eve|
    ...
    eve.vm.hostname = "eve"
    eve.vm.network "private_network", ip: "192.168.56.103", virtualbox__intnet: "internal"
